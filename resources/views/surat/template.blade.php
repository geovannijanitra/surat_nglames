	...
	<center>
		...
		<table width="300">
			<tr>
				<td>
                    <center>
                        <font size="16px"><b><u>SURAT KETERANGAN DOMISILI</u></b></font>
                    </center>
                </td>
			</tr>
			<tr>
		...
		<table width="350">
            ...
            <tr>
				...
				<td><font size="16px">: &emsp;{{ $umurPenduduk }} Tahun</font></td>
			</tr>
            <tr>
		...
		<table width="400">
            <tr>
				...
				<td><font size="16px">Menerangkan bahwa orang tersebut di atas benar-benar berdomisili di RT {{ $RT }}</font></td>
			</tr>
            <tr>
				<td width="15px"><font size="16px" class="text2">2. </font></td>
				<td><font size="16px">RW {{ $RW }} Kel Nglames Kec/Kab Madiun, dan memiliki usaha {{ $usaha }} </font></td>
			</tr>
            <tr>
            ...
            <tr>
				...
				<td><font size="16px">{{ $keperluan }}</font></td>
			</tr>
		</table>
		<br>
        <table width="400">
