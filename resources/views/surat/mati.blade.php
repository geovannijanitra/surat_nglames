...
<body>
		...
		<div class="atas">
            <table>
                ...
                <tr>
                    ...
                    <td colspan="7"><font size="12px">: {{ $kepala }}</font></td>
                </tr>
                <tr>
                    <td  colspan="2"><font size="12px"> Nomer Kepala Keluarga</font></td>
                    <td colspan="7"><font size="12px">: {{ $noKk }}</font></td>
                </tr>
                <tr>
                    <td class="border" colspan="7"><font size="12px"><b>JENAZAH</b></font></td>
                </tr>
                <tr>

                    <td class="left-side" colspan="2" width="100"><font size="12px">1.  NIK</font></td>
                    <td class="right-side" colspan="7"><font size="12px">: {{ $nik }}</font></td>
                </tr>
                <tr>

                    <td class="left-side" colspan="2" width="100"><font size="12px">2.  Nama Lengkap</font></td>
                    <td class="right-side"  colspan="7"><font size="12px">: {{ $nama }}</font></td>
                </tr>
                <tr>

                    <td class="left-side" colspan="2" width="100"><font size="12px">3.  Jenis Kelamin</font></td>
                    <td class="right-side"  colspan="7"><font size="12px">: {{ $kelamin }}</font></td>
                </tr>
                <tr>
                    ...
                    <td class="right-side" colspan="2"><font size="12px"> {{ $umurJenazah }}</font></td>
                </tr>
                <tr>

                    <td class="left-side" colspan="2" width="100"><font size="12px">5.  Tempat Lahir</font></td>
                    <td class="right-side" colspan="7"><font size="12px">: {{ $tempatLahir }}</font></td>
                ...
                <tr>
                    ...
                    <td class="right-side"  colspan="7"><font size="12px">: {{ $agama }}</font></td>
                </tr>
                <tr>

                    <td class="left-side" colspan="2" width="100"><font size="12px">7.  Pekerjaan</font></td>
                    <td class="right-side"  colspan="7"><font size="12px">:  {{ $pekerjaan }}</font></td>
                </tr>
                <tr>

                    <td class="left-side" colspan="2" width="100"><font size="12px">8.  Alamat</font></td>
                    <td class="right-side"  colspan="7"><font size="12px">: {{ $alamat }}</font></td>
                </tr>
                {{-- <tr>
                ...
                <tr>
                    ...
                    <td class="left-side" colspan="2" width="100"><font size="12px">1.  NIK</font></td>
                    <td class="right-side" colspan="7"><font size="12px">: {{ $nikAyah  ?? ''}}</font></td>
                </tr>
                <tr>

                    <td class="left-side" colspan="2" width="100"><font size="12px">2.  Nama Lengkap</font></td>
                    <td class="right-side"  colspan="7"><font size="12px">: {{ $namaAyah  ?? ''}}</font></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="right-side"  colspan="7"><font size="12px">: {{ $pekerjaanAyah  ?? ''}}</font></td>
                </tr>
                <tr>
                    <td class="left-side" colspan="2" width="100"><font size="12px">5.  Alamat</font></td>
                    <td class="right-side"  colspan="7"><font size="12px">: {{ $alamatAyah  ?? ''}}</font></td>
                </tr>
                {{-- <tr>
                    <td colspan="2" width="100" class="text2"><font size="12px">8.  Alamat</font></td>
                    <td ><font size="12px">a.Desa/Kelurahan</font></td>
                ...
                <tr>
                    ...
                    <td class="left-side" colspan="2" width="100"><font size="12px">1.  NIK</font></td>
                    <td class="right-side" colspan="7"><font size="12px">: {{ $nikIbu  ?? ''}}</font></td>
                </tr>
                <tr>

                    <td class="left-side" colspan="2" width="100"><font size="12px">2.  Nama Lengkap</font></td>
                    <td class="right-side"  colspan="7"><font size="12px">: {{ $namaIbu  ?? ''}}</font></td>
                </tr>
                <tr>
                    <td class="left-side" colspan="2" width="100"><font size="12px">3.  Tanggal Lahir / Umur</font></td>
                ...
                <tr>
                    <td class="left-side" colspan="2" width="100"><font size="12px">4.  Pekerjaan</font></td>
                    <td class="right-side"  colspan="7"><font size="12px">: {{ $pekerjaanIbu  ?? ''}}</font></td>
                </tr>
                <tr>
                    <td class="left-side" colspan="2" width="100"><font size="12px">5.  Alamat</font></td>
                    <td class="right-side"  colspan="7"><font size="12px">: {{ $alamatIbu  ?? ''}}</font></td>
                </tr>
                {{-- <tr>
                    <td colspan="2" width="100" class="text2"><font size="12px">8.  Alamat</font></td>
                    <td ><font size="12px">a.Desa/Kelurahan</font></td>
                ...
                <tr>
                    ...
                    <td class="left-side" colspan="2" width="100"><font size="12px">1.  NIK</font></td>
                    <td class="right-side" colspan="7"><font size="12px">: {{ $nikPelapor  ?? ''}}</font></td>
                </tr>
                <tr>

                    <td class="left-side" colspan="2" width="100"><font size="12px">2.  Nama Lengkap</font></td>
                    <td class="right-side"  colspan="7"><font size="12px">: {{ $namaPelapor  ?? ''}}</font></td>
                </tr>
                <tr>
                    <td class="left-side" colspan="2" width="100"><font size="12px">3.  Tanggal Lahir / Umur</font></td>
                    <td  colspan="2"><font size="12px">: {{ $tanggalLahirPelapor  ?? ''}}</font></td>
                    <td><font size="12px"> Umur :</font></td>
                    <td class="right-side" colspan="2"><font size="12px"> {{ $umurPelapor  ?? ''}}</font></td>
                </tr>
                <tr>
                    <td class="left-side" colspan="2" width="100"><font size="12px">4.  Pekerjaan</font></td>
                    <td class="right-side"  colspan="7"><font size="12px">: {{ $pekerjaanPelapor  ?? ''}}</font></td>
                </tr>
                <tr>
                    <td class="left-side" colspan="2" width="100"><font size="12px">5.  Alamat</font></td>
                    <td class="right-side"  colspan="7"><font size="12px">: {{ $alamatPelapor  ?? ''}}</font></td>
                </tr>
                <tr>
		...
		<table class="ttd" width="500">
        	...
        	<tr>
    			<td class="white"><font size="12px">Yang Berhak Tanda Tangan</font></td>
    			<td><font size="12px">{{ $jabatanPerangkat }}</font></td>
  			</tr>
            <tr> <td  colspan="3" height="10"><img src="transp.gif" alt="" width="1" height="75"></td> </tr>
            <tr>
    			<td class="white"><font size="12px">{{ $nama }}</font></td>
